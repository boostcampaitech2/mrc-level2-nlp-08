...
def main():
    ...
    # datasets = load_from_disk("../../tt/test_es_top_20")
    datasets = load_from_disk("../../hb_k_20")
    ...
    model = AutoModelForQuestionAnswering.from_pretrained(
        # "../outputs/concat_k_5/checkpoint-3176",  # 8 epoch # 2epoch으로도해보면좋을듯..
        "/opt/ml/develop/outputs/65_830_2epoch_my_concat_k_5_hb_k_20",
        # "../outputs/sot_train_with_validation",
