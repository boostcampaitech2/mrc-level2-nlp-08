...
class Conv1DRobertaForQuestionAnswering(RobertaPreTrainedModel):
    ...
    def __init__(self, pretrained_model_name_or_path, config):
        ...
        self.conv1d_k1 = nn.Conv1d(in_channels=self.hidden_dim, out_channels=self.hidden_dim, kernel_size=1, padding=0)
        self.conv1d_k3 = nn.Conv1d(in_channels=self.hidden_dim, out_channels=self.hidden_dim, kernel_size=3, padding=1)
        self.conv1d_k5 = nn.Conv1d(in_channels=self.hidden_dim, out_channels=self.hidden_dim, kernel_size=5, padding=2)
        self.relu = nn.ReLU()
